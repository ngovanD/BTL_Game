...
public class AiDetector : MonoBehaviour
{
    ...
    [SerializeField] float detectionCheckDelay = 0.1f;
    [SerializeField] private Transform target = null;
    [SerializeField] private LayerMask playerLayerMark;
    ...
    private bool CheckTargetVisible()
    {
        ...
        {
            return (playerLayerMark & (1 << result.collider.gameObject.layer)) != 0;
        }
        return false;
    }
    ...
    {
        Collider2D collision = Physics2D.OverlapCircle(transform.position, viewRadius, playerLayerMark);
        if (collision != null)
        {
